		  ...
		  <header id="header">
		    <div class="container main-menu">
		    	<div class="row align-items-center justify-content-between d-flex">
			      <div id="logo">
			        <a href="index.html"><img src="${pageContext.request.contextPath }/resources/img/gp.png" alt="" title="" /></a>
			      </div>
			      <nav id="nav-menu-container">
			        <ul class="nav-menu">
			          <li><a href="${pageContext.request.contextPath }/empInfo">Employee Information</a></li>
				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-between">
						<div class="col-lg-6 col-md-6 banner-left">
							...
							<h2>Great Progress Infosys.Pvt.Ltd</h2>
							<p>
						...
						<div class="col-lg-6 col-md-6 banner-right d-flex align-self-end">
							<img class="img-fluid" src="${pageContext.request.contextPath }/resources/img/homeimg.jpg" alt="">
						</div>
					</div>
				</div>					
			</section>
                        ...
                        <div class="row grid">
                            	...
                            	<div class="relative">
	                            	<div class="thumb">
	                            		<div class="overlay overlay-bg"></div>
	                            		 <img class="image img-fluid" src="${pageContext.request.contextPath }/resources/img/p1.jpg" alt="">
	                            	</div>
									<a href="${pageContext.request.contextPath }/resources/img/p1.jpg" class="img-pop-up">	
									  <div class="middle">
									    <div class="text align-self-center d-flex"><img src="${pageContext.request.contextPath }/resources/img/preview.png" alt=""></div>
									  </div>
								</a>                              		
                            	</div>
								<div class="p-inner">
                            ...
                            <div class="single-portfolio col-sm-4 all raster">
                            	<div class="relative">
	                            	<div class="thumb">
	                            		<div class="overlay overlay-bg"></div>
	                            		 <img class="image img-fluid" src="${pageContext.request.contextPath }/resources/img/p2.jpg" alt="">
	                            	</div>
									<a href="${pageContext.request.contextPath }/resources/img/p2.jpg" class="img-pop-up">	
									  <div class="middle">
									    <div class="text align-self-center d-flex"><img src="${pageContext.request.contextPath }/resources/img/preview.png" alt=""></div>
									  </div>
								</a>                              		
                            ...
                            <div class="single-portfolio col-sm-4 all ui">
                            	<div class="relative">
	                            	<div class="thumb">
	                            		<div class="overlay overlay-bg"></div>
	                            		 <img class="image img-fluid" src="${pageContext.request.contextPath }/resources/img/p3.jpg" alt="">
	                            	</div>
									<a href="${pageContext.request.contextPath }/resources/img/p3.jpg" class="img-pop-up">	
									  <div class="middle">
									    <div class="text align-self-center d-flex"><img src="${pageContext.request.contextPath }/resources/img/preview.png" alt=""></div>
									  </div>
									</a> 
                            ...
                            <div class="single-portfolio col-sm-4 all printing">
                            	<div class="relative">
	                            	<div class="thumb">
	                            		<div class="overlay overlay-bg"></div>
	                            		 <img class="image img-fluid" src="${pageContext.request.contextPath }/resources/img/p4.jpg" alt="">
	                            	</div>
									<a href="${pageContext.request.contextPath }/resources/img/p4.jpg" class="img-pop-up">	
									  <div class="middle">
									    <div class="text align-self-center d-flex"><img src="${pageContext.request.contextPath }/resources/img/preview.png" alt=""></div>
									  </div>
									</a>                            		
                            ...
                            <div class="single-portfolio col-sm-4 all vector">
                            	...
                            	<div class="thumb">
	                            		<div class="overlay overlay-bg"></div>
	                            		 <img class="image img-fluid" src="${pageContext.request.contextPath }/resources/img/p5.jpg" alt="">
	                            	</div>
									<a href="${pageContext.request.contextPath }/resources/img/p5.jpg" class="img-pop-up">	
									  <div class="middle">
									    <div class="text align-self-center d-flex"><img src="${pageContext.request.contextPath }/resources/img/preview.png" alt=""></div>
									  </div>
									</a>                             		
                            ...
                            <div class="single-portfolio col-sm-4 all raster">
                            	<div class="relative">
	                            	<div class="thumb">
	                            		<div class="overlay overlay-bg"></div>
	                            		 <img class="image img-fluid" src="${pageContext.request.contextPath }/resources/img/p6.jpg" alt="">
	                            	</div>
									<a href="${pageContext.request.contextPath }/resources/img/p6.jpg" class="img-pop-up">	
									  <div class="middle">
									    <div class="text align-self-center d-flex"><img src="${pageContext.request.contextPath }/resources/img/preview.png" alt=""></div>
									  </div>
									</a>                             		
				...
				<div class="container">
					...
					<div class="row">	
						<div class="single-recent-blog col-lg-4 col-md-4">
							<div class="thumb">
								<img class="f-img img-fluid mx-auto" src="${pageContext.request.contextPath }/resources/img/b1.jpg" alt="">	
							</div>
							<div class="bottom d-flex justify-content-between align-items-center flex-wrap">
								<div>
									<img class="img-fluid" src="${pageContext.request.contextPath }/resources/img/user.png" alt="">
						...
						<div class="single-recent-blog col-lg-4 col-md-4">
							<div class="thumb">
								<img class="f-img img-fluid mx-auto" src="${pageContext.request.contextPath }/resources/img/b2.jpg" alt="">	
							</div>
							<div class="bottom d-flex justify-content-between align-items-center flex-wrap">
								<div>
									<img class="img-fluid" src="${pageContext.request.contextPath }/resources/img/user.png" alt="">
						...
						<div class="single-recent-blog col-lg-4 col-md-4">
							<div class="thumb">
								<img class="f-img img-fluid mx-auto" src="${pageContext.request.contextPath }/resources/img/b3.jpg" alt="">	
							</div>
							<div class="bottom d-flex justify-content-between align-items-center flex-wrap">
								<div>
									<img class="img-fluid" src="${pageContext.request.contextPath }/resources/img/user.png" alt="">
		            ...
		            <div class="brand-wrap">
		                <div class="row align-items-center active-brand-carusel justify-content-start no-gutters">
		                    <div class="col single-brand">
		                        <a href="#"><img class="mx-auto" src="${pageContext.request.contextPath }/resources/img/l1.png" alt=""></a>
		                    </div>
		                    <div class="col single-brand">
		                        <a href="#"><img class="mx-auto" src="${pageContext.request.contextPath }/resources/img/l2.png" alt=""></a>
		                    </div>
		                    <div class="col single-brand">
		                        <a href="#"><img class="mx-auto" src="${pageContext.request.contextPath }/resources/img/l3.png" alt=""></a>
		                    </div>
		                    <div class="col single-brand">
		                        <a href="#"><img class="mx-auto" src="${pageContext.request.contextPath }/resources/img/l4.png" alt=""></a>
		                    </div>
		                    <div class="col single-brand">
		                        <a href="#"><img class="mx-auto" src="${pageContext.request.contextPath }/resources/img/l5.png" alt=""></a>
		                    </div>
		                </div>
		            </div>
		        </div>
